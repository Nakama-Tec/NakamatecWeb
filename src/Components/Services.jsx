    ...
    return (
        <div className="p-4">
            <div className="flex flex-col items-center justify-center">
                <p className="text-3xl sm:text-5xl text-[#00275c] font-bold">
                    Nuestros <span className="text-white">servicios</span>
                </p>
            </div>
            <div className="mt-8 flex flex-col items-center m-2 sm:m-5">
                <div className="flex flex-col gap-4 w-full max-w-md">
                    <div className="bg-[#00275c] text-white p-4 rounded-lg transform transition-transform duration-300 hover:scale-105 cursor-pointer">
