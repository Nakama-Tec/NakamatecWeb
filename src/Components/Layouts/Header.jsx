...
return (
<header>
    <div className='flex justify-evenly items-center bg-white font-semibold p-4'>
        
        {/* Contenedor del logo y el nombre */}
        <div className="flex items-center gap-2">
            <img src={LogoNakama} alt="Logo Nakama" className='h-20' />
            <div>
                <p className='text-4xl text-[#095ba4] leading-none'>Nakama<span className="font-bold">Tec</span></p>
                <p className='text-xl text-[#095ba4]'>Software</p>
            </div>
        </div>
